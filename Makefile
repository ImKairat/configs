...
CONFIG_FILES = .mycfg .vimrc .inputrc
DEST_DIR = $(HOME)
BASHRC = $(HOME)/.bashrc
...
show:
	...
	@echo "\033[1;33mContainerization:$(COLOR_RESET)"
	@printf "\033[1;32mdr:\033[0m %-40s  | \033[1;32mpm:\033[0m %-30s\n" "Run Docker with sudo" "Run Podman with sudo"
	@echo ""
